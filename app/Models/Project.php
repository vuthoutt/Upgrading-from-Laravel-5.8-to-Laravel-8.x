...
class Project extends ModelBase
{
    ...
    public function survey(){
        return $this->hasMany('App\Models\Survey', 'project_id', 'id');
    }

    public function sponsor(){
        return $this->belongsTo('App\Models\ProjectSponsor', 'sponsor_id', 'id');
    }

    public function surveyType(){
        return $this->belongsTo('App\Models\SurveyType', 'survey_type', 'id');
    }

    public function rrCondition(){
        return $this->belongsTo('App\Models\RRCondition', 'rr_condition', 'id');
    }

    public function document(){
        return $this->hasMany('App\Models\Document', 'project_id', 'id');
    }
    ...
    public function projectType(){
        return $this->belongsTo('App\Models\ProjectType', 'project_type', 'id');
    }

    public function commentHistory() {
        return $this->hasMany('App\Models\ProjectComment','record_id','id')->orderBy('tbl_project_comment.created_at','desc');;
    }
    ...
    public function getProjectTypeTextAttribute() {
        ...
        switch ($projectType) {
            ...
            case 13:
                return 'Health & Safety Assessment';
        }
    ...
    public function getCompletedDateProjectAttribute() {
        $value = $this->attributes['completed_date'];
        if (is_null($value) || $value == 0) {
            return null;
        }
        return date("d/m/Y", $value);
