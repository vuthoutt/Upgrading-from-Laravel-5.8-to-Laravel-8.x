...
class PriorityAssessmentRisk extends ModelBase
{
    ...
    public function parents() {
        return $this->hasOne('App\Models\DropdownItem\PriorityAssessmentRisk', 'id', 'parent_id');
    }
    ...
    {
        return $this->hasMany('App\Models\DropdownItem\PriorityAssessmentRisk', 'parent_id', 'id');
    }
