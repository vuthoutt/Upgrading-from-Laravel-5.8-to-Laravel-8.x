...
class AssemblyPoint extends ModelBase
{
    protected $table = 'cp_assembly_points';
    ...
    public function assemblyPointPhotoShineDocumentStorage() {
        return $this->hasOne('App\Models\ShineCompliance\ShineDocumentStorage','object_id', 'id')->where('type',ASSEMBLY_POINT_PHOTO);
    }
