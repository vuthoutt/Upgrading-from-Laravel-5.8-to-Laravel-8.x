...
class CreateCpHazardActionRecommendationTable extends Migration {
	...
	public function up()
	{
		Schema::create('cp_hazard_action_recommendation', function(Blueprint $table)
		{
	...
	{
		Schema::drop('cp_hazard_action_recommendation');
	}
