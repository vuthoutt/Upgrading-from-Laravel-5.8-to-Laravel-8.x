...
class CreateCpEquipmentSpecificLocationTable extends Migration {
	...
	public function up()
	{
		Schema::create('cp_equipment_specific_location', function(Blueprint $table)
		{
	...
	{
		Schema::drop('cp_equipment_specific_location');
	}
