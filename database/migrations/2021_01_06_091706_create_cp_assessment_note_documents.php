...
class CreateCpAssessmentNoteDocuments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cp_assessment_note_documents', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cp_assessment_note_documents');
    }
}
