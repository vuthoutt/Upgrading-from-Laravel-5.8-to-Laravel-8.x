...
class CreateCpHazardSpecificLocationTable extends Migration {
	...
	public function up()
	{
		Schema::create('cp_hazard_specific_location', function(Blueprint $table)
		{
	...
	{
		Schema::drop('cp_hazard_specific_location');
	}
