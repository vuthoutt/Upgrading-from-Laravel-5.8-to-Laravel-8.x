...
@section('content')
    ...
    @include('shineCompliance.partials.nav',['breadCrumb' => 'equiment_document_com', 'color' => 'red', 'data' => $object])
    <div class="container-cus prism-content pad-up">
        ...
        <div class="main-content mar-up">
            ...
            <div class="row">
                ...
                ['image' =>  asset(\ComplianceHelpers::getSystemFile($object->id, EQUIPMENT_PHOTO)),
                'id' => $object->id ?? 0,
                    ...
                    <div class="property-detail">
                        <div class="row">
                            <div class="col-12 mb-1 pr-0">
                                ...
                                <input type="hidden" class="equip_id" name="equip_id" value="{{$object->id}}">
                        ...
                        @include('shineCompliance.modals.property_category_add',[
                            ...
                            'property_id' => $object->property_id,'equipment_id' => $object->id
                            ])
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#property-document-add").on("show.bs.modal", function (e) {
                var that = $(this);
                var parent_type = 3;//default selected equipment
                var system_id = $('.sys_id').val();
                var equipment_id = $('.equip_id').val();
                var programme_id = '';
                ...
                $(that_parent).closest('.modal').find('.property_programme').hide();
                $(that_parent).closest('.modal').find('.property_equipment').hide();
                if(parent_type == 2 || parent_type == 3 || parent_type == 4){//2 system, 3 equipment, 4 programme
                    ajaxSystem(that_parent, property_id, system_id);
                    $(that_parent).closest('.modal').find('.property_system').show();
                    if(parent_type == 3){
                        displayAllOption(that_parent, true, system_id);
