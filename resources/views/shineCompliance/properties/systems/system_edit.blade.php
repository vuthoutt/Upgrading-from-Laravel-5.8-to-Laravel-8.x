...
@section('content')
@include('shineCompliance.partials.nav',['breadCrumb' => 'system_edit', 'color' => 'red', 'data' => $system ?? '' ])
<div class="container-cus prism-content pad-up pl-0">
    <div class="row">
        <h3 class="col-12 title-row">Edit System</h3>
    </div>
    <div class="main-content">
        <form id="form_edit_property" enctype="multipart/form-data" class="form-shine" method="POST" action="{{  route('shineCompliance.systems.post_edit',['property_id' => $system->property_id ?? 1, 'id' => $system->id ?? 0]) }}">
            @csrf
