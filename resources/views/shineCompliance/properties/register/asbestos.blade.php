...
@section('content')
@if($section)
    @include('shineCompliance.partials.nav',['breadCrumb' => 'register_asbestos_summary', 'color' => 'red', 'data' =>  $property])
@else
                ...
                <div class="col-md-9 pr-0 pl-0">
                    ...
                    @else
                        @include('shineCompliance.tables.item_summary', [
                            ...
                            'data' => $data_summary,
                            'summary' => true,
                            'header' => ['Summary','Area/floor Reference','Room/location Description','Product/debris type', 'MAS',''],
