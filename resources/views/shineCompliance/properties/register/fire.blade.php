...
@section('content')
@if($section)
    @include('shineCompliance.partials.nav',['breadCrumb' => 'register_fire_summary', 'color' => 'red', 'data' =>  $property])
@else
    @include('shineCompliance.partials.nav',['breadCrumb' => 'register_fire', 'color' => 'red', 'data' =>  $property])
@endif
            ...
            @else
                <div class="col-md-9 pr-0 pl-0">
                        @include('shineCompliance.tables.property_register_summary', [
                            ...
                            'normalTable' => true,
                            'link' => route('shineCompliance.assessment.get_add_hazard',['property_id' => $property_id, 'assess_type' => ASSESSMENT_FIRE_TYPE]),
                            'collapsed' => false
                            ])
                    @include('shineCompliance.tables.property_register_summary', [
                            'title' => 'Property Decommissioned Fire Hazard Summary',
