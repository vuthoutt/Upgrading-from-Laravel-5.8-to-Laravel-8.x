@extends('shineCompliance.tables.main_table',[
        'header' => ['Reference','Description','Accessibility','Items'],
    ])
        ...
        @foreach($data as $key => $dataRow)
            <tr>
                @if($dataRow->survey_id == 0)
                    <td><a href="{{ route('shineCompliance.property_detail',['id' => $dataRow->property_id,'section' => SECTION_ROOM_LOCATION_SUMMARY, 'location' => $dataRow->id,
