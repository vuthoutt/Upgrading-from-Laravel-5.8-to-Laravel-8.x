...
@section('datatable_content')
    @if(isset($data) and count($data) > 0)
        ...
        <tr>
            ...
            <td><a href="{{ route('shineCompliance.property.property_detail', $dataRow->property->id) }}">{{ $dataRow->property->property_reference ?? '' }}</a></td>
            ...
            <td width="10%">{!! \CommonHelpers::getIncidentReportPdfViewing($dataRow->id, $dataRow->status) !!}</td>
