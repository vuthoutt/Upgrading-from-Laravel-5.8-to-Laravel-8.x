    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header {{ isset($color) ? \CommonHelpers::getComplianceNavColor($color) : 'red_color' }}">
                <h5 class="modal-title" id="exampleModalLabel">shine{{ isset($color) ? 'Arc' : 'Prism' }} - {{ ($action == 'add') ? 'Add' : 'Edit' }} Property Group</h5>
            ...
            <meta name="csrf-token" content="{{ csrf_token() }}" />
                ...
                <div class="mb-4" style="text-align: center;">
                    ...
                    <button type="submit" class="btn light_grey_gradient_button shine_submit_modal fs-8pt" id="submit_zone">Submit</button>
                </div>
            </form>
        </div>
    </div>
