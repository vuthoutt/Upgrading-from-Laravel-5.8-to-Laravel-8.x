    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding-left: 30px;min-height:140px ">
                ...
                <div class="row register-form">
                 ...
                 @if( (\Auth::user()->client_type == 0 || \Auth::user()->client_id == $project->client_id) and ( in_array($doc_cat, [TENDER_DOC_CATEGORY]) ) )
                    @include('forms.form_datepicker',['title' => 'Deadline Date:', 'name' => 'deadline_picker', 'width_label' => 4, 'id' => 'deadline'.( $unique_value ?? '') , 'data' => \CommonHelpers::convertTimeStampToTime($data->deadline) ])
                @endif
            ...
            <div class="mb-4" style="text-align: center;">
                ...
                <button type="submit" class="btn light_grey_gradient_button shine_submit_modal fs-8pt" id="edit_document_{{ $unique_value ?? '' }}">Save</button>
            </div>
            </form>
        </div>
    </div>
