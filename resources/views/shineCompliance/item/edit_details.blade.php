<div class="offset-top40">
    @include('shineCompliance.forms.form_input_hidden',['name' => 'location_id', 'data' => $item->location_id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'area_id', 'data' => $item->area_id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'survey_id', 'data' => $item->survey_id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'property_id', 'data' => $item->property_id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'item_id', 'data' => $item->id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'action', 'data' => 'update' ])
    @include('shineCompliance.forms.form_text',['title' => 'Item ID:', 'data' => $item->reference ])
    @include('shineCompliance.form_search.search_item',['title' => 'Item Name:', 'name' => 'name', 'required' => true, 'data' => $item->name ,'id' => 'item'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Item Type:', 'data' => $itemTypes,
                                    'name' => 'item-type', 'key'=> 'id', 'value'=>'description',
                                    'compare_value' => ($item->state == ITEM_NOACM_STATE) ? ITEM_NON_ASBESTOS_TYPE_ID : 174
                                    , 'required' => true ])
    @include('shineCompliance.forms.form_dropdown_not_assessed',['assess_type' => 'item','compare_value' => $item->not_assessed, 'compare_reason' => $item->not_assessed_reason ])
    <div class="row register-form acm">
        ...
        <div class="col-md-5">
            <div class="form-group ">
                <select  class="form-control  @error('accessibility') is-invalid @enderror fs-8pt" name="accessibility" id="accessibility">
    ...
    <div class="row register-form acm-child inaccessible">
        <label class="col-md-3 col-form-label text-md-left font-weight-bold fs-8pt" >Assessment Type:</label>
        <div class="col-md-5">
            <div class="form-group ">
    ...
    <div class="row register-form accessible">
        <label class="col-md-3 col-form-label text-md-left font-weight-bold fs-8pt" >Sample/link ID:</label>
        <div class="col-md-5">
            <div class="form-group ">
    ...
    <div id="sampleIDOtherDiv">
        <div class="row register-form">
            <div class="col-md-5 offset-md-3 mb-4 fs-8pt" id="sample_ref">
                <p>Sample Reference:</p>
                <textarea class="text-area-form" name="sample-other" id="sampleIDOther" ></textarea>
            </div>
            <div class="col-md-5 offset-md-3 mb-4 fs-8pt">
                    <p>Sample Comment:</p>
                    <div id="os_comment">
    ...
    @include('shineCompliance.forms.form_dropdown',['title' => 'Reason:', 'data' => $reasons, 'name' => 'reasons', 'key'=> 'id', 'value'=>'description', 'compare_value' => $selectedReason, 'class_other' =>'inaccessible acm-child' ])
    ...
    <div class="row register-form mb-4">
        <label class="col-md-3 col-form-label text-md-left font-weight-bold fs-8pt" >Product/debris Type:</label>
        <div class="col-md-5">
    ...
    @include('shineCompliance.forms.form_dropdown',['title' => 'Asbestos Type:', 'data' => $abestosTypes, 'name' => 'abestosTypes[]','id' => 'abestosTypes', 'key'=> 'id', 'value'=>'description', 'compare_value' => \CommonHelpers::checkArrayKey2($selectedAsbetosType, 0), 'class_other' =>'acm' ])
    ...
    <div class="row register-form mb-4">
        <label class="col-md-3 col-form-label text-md-left font-weight-bold fs-8pt" >Extent:</label>
        <div class="col-md-2" >
    ...
    @if(empty($survey) || ( isset($survey->surveySetting) and optional($survey->surveySetting)->is_require_r_and_d_elements == ACTIVE) )
        @include('shineCompliance.forms.form_checkbox',['title' => 'R&D Element:', 'data' => optional($item->itemInfo)->is_r_and_d_element,'compare' => 1, 'name' => 'rAndDElement', 'class_other' =>'acm accessible' ])
    @endif

    <div class="row register-form">
        <label class="col-md-3 col-form-label text-md-left font-weight-bold fs-8pt" >Comments:</label>
...
@push('javascript')
    ...
    $(document).ready(function(){
        ...
        $("#abestosTypes1").change(function(){
            ...
            if (text == "Other" || text == 'Amphibole (exc. Crocidolite) ' || text == 'Crocidolite' ) {
