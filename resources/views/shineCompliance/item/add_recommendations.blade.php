<div class="offset-top40">
    @include('shineCompliance.forms.form_dropdown',['title' => 'Actions / recommendations', 'data' => $recommendations, 'name' => 'ActionsRecommendations[]', 'key'=> 'id', 'value'=>'description', 'id' => 'ActionsRecommendations' ])
    ...
    <div class="row register-form" id="other_action_rec">
        <div class="col-md-5 offset-md-3">
            <input class="form-control mt-4" type="text" name="ActionsRecommendations_other" id="ActionsRecommendations_other" value="" />
        </div>
    </div>
</div>
@push('javascript')
