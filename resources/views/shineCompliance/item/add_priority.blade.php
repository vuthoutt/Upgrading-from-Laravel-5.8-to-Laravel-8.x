<div class="offset-top40">
    ...
    @include('shineCompliance.forms.form_dropdown',['title' => 'Primary', 'data' => $pasPrimaries, 'name' => 'pasPrimary', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Secondary', 'data' => $pasSecondaryies, 'name' => 'pasSecondary', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])

    @include('shineCompliance.forms.form_text_right',['title' => 'Likelihood of Disturbance'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Location', 'data' => $pasLocations, 'name' => 'pasLocation', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Accessibility', 'data' => $pasAccessibilities, 'name' => 'pasAccessibility', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Extent/Amount', 'data' => $pasExtents, 'name' => 'pasExtent', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])

    @include('shineCompliance.forms.form_text_right',['title' => '  Human Exposure Potential'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Number', 'data' => $pasNumbers, 'name' => 'pasNumber', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Frequency', 'data' => $pasHumanFrequencys, 'name' => 'pasHumanFrequency', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Average Time', 'data' => $pasAverageTimes, 'name' => 'pasAverageTime', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])

    @include('shineCompliance.forms.form_text_right',['title' => '  Maintenance Activity'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Type', 'data' => $pasTypes, 'name' => 'pasType', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Frequency', 'data' => $pasMaintenanceFrequencys, 'name' => 'pasMaintenanceFrequency', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
