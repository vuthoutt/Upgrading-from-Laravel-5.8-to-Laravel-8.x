<div class="offset-top40">
    ...
    <div id="materialaltdiv">
        @include('shineCompliance.forms.form_dropdown',['title' => 'Product Type (a)', 'data' => $assessmentTypeKeys, 'name' => 'assessmentTypeKey', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
        @include('shineCompliance.forms.form_dropdown',['title' => 'Extent of Damage (b)', 'data' => $assessmentDamageKeys, 'name' => 'assessmentDamageKey', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
        @include('shineCompliance.forms.form_dropdown',['title' => 'Surface Treatment (c)', 'data' => $assessmentTreatmentKeys, 'name' => 'assessmentTreatmentKey', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
        @include('shineCompliance.forms.form_dropdown',['title' => 'Asbestos Fibre (d)', 'data' => $assessmentAsbestosKeys, 'name' => 'assessmentAsbestosKey', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score' ])
