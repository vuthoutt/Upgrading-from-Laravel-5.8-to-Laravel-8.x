<div class="offset-top40">
    ...
    @include('shineCompliance.forms.form_dropdown',['title' => 'Primary', 'data' => $pasPrimaries, 'name' => 'pasPrimary', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasPrimaries ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Secondary', 'data' => $pasSecondaryies, 'name' => 'pasSecondary', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasSecondaryies ])

    @include('shineCompliance.forms.form_text_right',['title' => 'Likelihood of Disturbance'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Location', 'data' => $pasLocations, 'name' => 'pasLocation', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasLocations ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Accessibility', 'data' => $pasAccessibilities, 'name' => 'pasAccessibility', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasAccessibilities ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Extent/Amount', 'data' => $pasExtents, 'name' => 'pasExtent', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasExtents ])

    @include('shineCompliance.forms.form_text_right',['title' => '  Human Exposure Potential'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Number', 'data' => $pasNumbers, 'name' => 'pasNumber', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasNumbers ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Frequency', 'data' => $pasHumanFrequencys, 'name' => 'pasHumanFrequency', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasHumanFrequencys ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Average Time', 'data' => $pasAverageTimes, 'name' => 'pasAverageTime', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasAverageTimes ])

    @include('shineCompliance.forms.form_text_right',['title' => '  Maintenance Activity'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Type', 'data' => $pasTypes, 'name' => 'pasType', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasTypes ])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Frequency', 'data' => $pasMaintenanceFrequencys, 'name' => 'pasMaintenanceFrequency', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasMaintenanceFrequencys ])
    ...
    <div class="row register-form">
        <label class="col-md-3 col-form-label text-md-left font-weight-bold fs-8pt" >Priority Risk Assessment</label>
        <div class="col-md-5">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function countTotalPas() {
            $('#risk-color-pas').removeAttr('class');
            var total = 0;
