<div class="offset-top40">
    @include('shineCompliance.forms.form_input_hidden',['name' => 'location_id', 'data' => $location->id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'area_id', 'data' => $location->area_id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'survey_id', 'data' => $location->survey_id ])
    @include('shineCompliance.forms.form_input_hidden',['name' => 'property_id', 'data' => $location->property_id ])
    @include('shineCompliance.form_search.search_item',['title' => 'Item Name:', 'name' => 'name', 'required' => true, 'data' =>'' ,'id' => 'item'])
    @include('shineCompliance.forms.form_dropdown',['title' => 'Item Type:', 'data' => $itemTypes, 'name' => 'item-type', 'key'=> 'id', 'value'=>'description', 'required' => true ])
    @include('shineCompliance.forms.form_dropdown_not_assessed',['assess_type' => 'item', 'compare_value' => '-1', 'compare_reason' => '-1' ])
    ...
    <div class="row register-form acm-child inaccessible">
        ...
        <div class="col-md-5">
            <div class="form-group ">
                <select  class="form-control fs-8pt" name="assessment" id="assessment">
    ...
    @include('shineCompliance.forms.form_dropdown',['title' => 'Reason:', 'data' => $reasons, 'name' => 'reasons', 'key'=> 'id', 'value'=>'description', 'class_other' =>'inaccessible acm-child' ])
    ...
    @include('shineCompliance.forms.form_dropdown',['title' => 'Asbestos Type:', 'data' => $abestosTypes, 'name' => 'abestosTypes[]','id' => 'abestosTypes', 'key'=> 'id', 'value'=>'description', 'class_other' =>'acm' ])
    <div class="row register-form acm">
        <div class="col-md-5 offset-md-3">
    ...
    <div class="row register-form mt-4" id="AsbestosTypeOther">
        <div class="col-md-5 offset-md-3">
            <div class="form-group">
                <select class="form-control fs-8pt" multiple="multiple" name="AsbestosTypeMore[]" id="AsbestosTypeMore">
    ...
    @if(empty($survey) || ( isset($survey->surveySetting) and optional($survey->surveySetting)->is_require_r_and_d_elements == ACTIVE) )
        @include('shineCompliance.forms.form_checkbox',['title' => 'R&D Element:', 'data' => '','compare' => 1, 'name' => 'rAndDElement', 'class_other' =>'acm accessible' ])
    @endif
