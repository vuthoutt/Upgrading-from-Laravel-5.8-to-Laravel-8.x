...
@section('content')
@if($assess_id == 0)
    @include('shineCompliance.partials.nav',['breadCrumb' => 'register_assembly_point_add', 'color' => 'red', 'data'=> $property])
@else
    @include('shineCompliance.partials.nav',['breadCrumb' => 'property_assessment_assembly_point_add', 'color' => 'orange', 'data'=> $assessment])
@endif
    <div class="container-cus prism-content pad-up">
        <div class="row">
            <h3 class="title-row">Add Assembly Point</h3>
        </div>
        <div class="main-content">
            <form method="POST" action="{{ route('shineCompliance.assessment.post_add_assembly_point',
            ['assess_id' => $assess_id]) }}" enctype="multipart/form-data" class="form-shine">
                ...
                @include('shineCompliance.forms.form_input',['title' => 'Assembly Point Name:','name' => 'name','required' => true])
                ...
                @include('shineCompliance.forms.form_upload',['title' => 'Assembly Point Photo:', 'name' => 'photo'])
                @include('shineCompliance.forms.form_text_area', ['title' => 'Assembly Point Comments:', 'name' => 'comment'])
                <a href="">
