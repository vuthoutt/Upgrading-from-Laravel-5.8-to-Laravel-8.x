<div class="row mr-bt-top">
    <div class="full-width">
        ...
        <div class="form-button-search" >
            @if($overall)
            <a href="{{ route('shineCompliance.all_zone.register') }}" style="text-decoration: none">
            ...
            @endif
            @if($asbestos)
            <a href="{{ route('shineCompliance.all_zone.asbestos') }}" style="text-decoration: none">
            ...
            @endif
            @if($fire)
            <a href="{{ route('shineCompliance.all_zone.fire') }}" style="text-decoration: none">
...
{{--             <a href="{{ route('shineCompliance.all_zone.gas') }}" style="text-decoration: none">
            ...
            @if($water)
            <a href="{{ route('shineCompliance.all_zone.water') }}" style="text-decoration: none">
