...
@section('content')
    @include('shineCompliance.partials.nav',['breadCrumb' => 'mixed_zone_properties_shineCompliance', 'color' => 'red', 'data' => $title ?? ''])
    ...
    <div class="container-cus prism-content pad-up" >
        ...
        <div class="main-content mar-up">
            @include('shineCompliance.properties.partials._property_button_search',[
                'backRoute' => route('zone_map', ['client_id' => 1]),
                'addRoute' =>  false,
                'search_action' => route('shineCompliance.zone.listing', ['type' => $type, 'client_id' => 1]),
                'addFilter' => true])
            <div class="row">
                        ...
                        <div style="width:100%; " >
                            <ul class="list-group">
                                <div class="list-group-img">
                                    <img src="{{ asset(\ComplianceHelpers::getFileImage(0, ZONE_PHOTO)) }}"  width="100%" height="230px" alt="">
                                </div>
                                <div class="list-group-button">
                                    <a href="{{ route('retrive_image',['type'=>  ZONE_PHOTO ,'id'=> 0, 'is_view' => true ]) }}" target="_blank"><button class="list-group-btn" style="margin-left:0px" title="Open"><i class="fa fa-image fa-2x"></i></button></a>
                                    <a href="{{ route('retrive_image',['type'=>  ZONE_PHOTO ,'id'=> 0]) }}" target="_blank"><button class="list-group-btn" title="Download"><i class="fa fa-download fa-2x"></i></button></a>
...
{{--                                <a href="{{route('shineCompliance.zone.zone_details', ['id' => 0])}}" class="list-group-item list-group-item-action {{ Route::currentRouteName() == 'shineCompliance.zone.zone_details' ? 'list-group-active' : 'list-group-item-danger'}} list-group-details" >Details</a>--}}
{{--                                @if(\CompliancePrivilege::checkRegisterDataPermission())--}}
{{--                                    <a href="{{ route('shineCompliance.zone.register', 0) }}" class="list-group-item list-group-item-action {{ isset($active_summary) ? 'list-group-active' : 'list-group-item-danger' }} list-group-details">Register</a>--}}
{{--                                @endif--}}
                                <a href="{{route('shineCompliance.zone.listing', ['type' => $type, 'client_id' => 1])}}" class="list-group-item {{ Route::currentRouteName() == 'shineCompliance.zone.listing' ? 'list-group-active' : 'list-group-item-danger'}} list-group-item-action list-group-details border-unset" disabled>Properties</a>
                            </ul>
                        </div>
                    </div>
                </div>
