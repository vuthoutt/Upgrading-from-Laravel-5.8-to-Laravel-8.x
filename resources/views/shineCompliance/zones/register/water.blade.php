...
@section('content')
@if($section)
    @include('shineCompliance.partials.nav',['breadCrumb' => 'register_zone_water_summary', 'color' => 'red', 'data' =>  $zone])
@else
    @include('shineCompliance.partials.nav',['breadCrumb' => 'register_zone_water', 'color' => 'red', 'data' =>  $zone])
@endif
<div class="container-cus prism-content pad-up">
    ...
    <div class="main-content mar-up">
        @include('shineCompliance.zones.partials._zone_button_register',['backRoute' => url()->previous(), 'zone_id' => $zone ])
        ...
        <div class="row">
            ...
            @else
                <div class="col-md-9 pr-0 pl-0">
                    ...
                    @include('shineCompliance.tables.property_register_summary', [
                            'title' => 'Property Group Decommissioned Water Hazard Summary',
