...
<div class="footer">
    <div class="clearfix">
        ...
        <div style="float: left; width: 25%;margin-top: 0!important;padding-top: 0!important">
            <img  class= "coverphoto" style="max-height: 100px; margin-left: 80px; margin-top: 0!important;padding-top: 0!important" width="100px" src="{{ CommonHelpers::getFile(1, CLIENT_LOGO, true) }}" alt="Property Survey Image"/>
        </div>
