    ...
    <div id="survey-report" class="page">
        ...
        <div id="asbestos-survey-report">
            @if($survey)
                    ...
                    <span>
                         @if(isset($survey->surveyDate->surveying_start_date) && $survey->surveyDate->surveying_start_date > 0 )
                            ...
                            @if(isset($survey->surveyDate->surveying_finish_date) && !empty($survey->surveyDate->surveying_finish_date)
                                && $survey->surveyDate->surveying_start_date != $survey->surveyDate->surveying_finish_date)
                ...
                ?>
                <h3 style="margin-bottom:30px;"><?= $surveyTitle ?></h3>
                @if($survey->project)
            ...
            <div id="surveyed-by" style="margin-top:30px;">
                ...
                <p>Summaries provide a limited overview of the data available, they are not designed to be used by those
                    ...
                    services.</p>
                <p>&nbsp;</p>
                <p>Contact the Asbestos Management Team for more detail asbestos.residentsafety@hackney.gov.uk.</p>
