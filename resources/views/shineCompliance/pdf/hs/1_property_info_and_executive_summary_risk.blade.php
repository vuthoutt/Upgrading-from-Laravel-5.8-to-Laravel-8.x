...
<div id="executisve-summary" style="margin-top:30px;">
    <div class="textdecoration alignment-title">
        <p class="alignment-text">{{ isset($new_title['info']) ? $new_title['info'] : '' }}.0 Property Information and Assessment Signatory</p>
    </div>
    <div class="content">
        <div class="mt30">
            <p>
                This Health and Safety Assessment report has been technically reviewed and authorised for issue to {{$assessment->property->clients->name ?? ''}} by the following authorised members of the
                {{$assessment->assessor->clients->name ?? ''}} Technical Team. This document holds legal status under the Health & Safety at Work Act (1974) and The Management of Health and Safety at
                Work Regulations (1999), and therefore should be used and made available accordingly.
            </p>
        </div>
    </div>
...
{{--        </tr>--}}
        ...
        <tr>
            ...
            <td>
                <p> {!! nl2br($propertyInfo['size_comments'] ?? '') ?? null !!}</p>
            </td>
        </tr>
    </table>
