...
<head>
    ...
    <style type="text/css">
        ...
        .pagecover{
            ...
            {{--background: url({{ asset('img/back_ground_cover.png') }}) no-repeat right center;--}}
        }
        .footerpagecover{
            position: absolute;
            bottom: 80px;
...
{{--                @if(CommonHelpers::getFile($assessment->property_id, PROPERTY_IMAGE, $is_pdf) == public_path('/img/no-image-icon.png'))--}}
...
{{--                @endif--}}
        ...
        <div class="page" >
            <div class="header alignment" style="min-height: 220px">
                <h2 > Health and Safety Assessment Report</h2>
                <div class="uprn">
            ...
            <table cellspacing="0" class="unset-border alignment" width="45%" style="margin-top: 30px;margin-left: 50px;margin-bottom: 30px">
                <tr>
                    <td width="25%">
                        <h3  >
            ...
            <div class="abs-footer" style="margin-bottom: 0px">
                <div style="width: 100%;height: 50px;background-color: #9d9d9c;text-align: center;">
                    <h1 style="color: white;padding: 10px">
                        Next Health and Safety Assessment Report Required {{ $assessment->next_inspection_assessment ?? '00/00/0000' }}
                    </h1>
                </div>
