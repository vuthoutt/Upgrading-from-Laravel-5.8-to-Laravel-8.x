...
<div id="executisve-summary" style="margin-top:30px;">
        <div class="textdecoration alignment-title">
            <p class="alignment-text">{{ isset($new_title['non']) ? $new_title['non'] : '' }}.0 Non-Assessed or Limited Accessed Rooms</p>
        </div>
    <div class="content">
        <div class="mt30">
            <p>
        ...
        <p class="mt30 mb30"><strong>Non-Accessed Equipment</strong></p>
        <!-- blue table -->
        <div class="tableItems tableGray" >
