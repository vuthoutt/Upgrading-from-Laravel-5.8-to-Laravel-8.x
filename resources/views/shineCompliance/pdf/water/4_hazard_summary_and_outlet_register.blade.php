...
<div id="executisve-summary" style="margin-top:30px;">
    @if(count($assessment->fireExits) == 0 &&  count($assessment->assemblyPoints) == 0 && count($assessment->vehicleParking) == 0)
        <div class="textdecoration alignment-title">
            <p class="alignment-text">3.0 Summary of Hazards with Recommendations</p>
        </div>
    @else
        <div class="textdecoration alignment-title">
            <p class="alignment-text">4.0 Summary of Hazards with Recommendations</p>
        </div>
    @endif
    <div class="content">
        <div class="mt30">
