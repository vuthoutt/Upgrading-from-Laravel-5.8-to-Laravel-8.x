...
<div style="margin-top:30px;" class="page">
    @if(count($incoming_mains) || count($miscs) || count($mixer_outlets) || count($cold_water_outlets)
        ...
        @if(count($assessment->fireExits) == 0 &&  count($assessment->assemblyPoints) == 0 && count($assessment->vehicleParking) == 0)
            @if($assessment->type == ASSESS_TYPE_WATER_RISK)
                <div class="textdecoration alignment-title">
                    <h2 class="alignment-text">9.0 Equipment Register</h2>
                </div>
            @else
                <div class="textdecoration alignment-title">
                    <h2 class="alignment-text">8.0 Equipment Register</h2>
                </div>
            @endif
        @else
            @if($assessment->type == ASSESS_TYPE_WATER_RISK)
                <div class="textdecoration alignment-title">
                    <h2 class="alignment-text">10.0 Equipment Register</h2>
                </div>
            @else
                <div class="textdecoration alignment-title">
                    <h2 class="alignment-text">9.0 Equipment Register</h2>
