...
<div id="executisve-summary" style="margin-top:30px;">
    ...
    <div class="content">
        <div class="mt30">
            <p>  This Legionella Risk Assessment report has been technically reviewed and authorised for issue to {{$assessment->property->clients->name ?? ''}} by the following authorised
