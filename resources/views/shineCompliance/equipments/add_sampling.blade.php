<div class="offset-top40">
    @include('shineCompliance.forms.form_dropdown',['title' =>'Has a Water Sample been collected?', 'name' => 'has_sample', 'no_first_op' => true,
                'data' => json_decode('[{"id": null, "description": "N/A"}, {"id": 0, "description": "No"}, {"id": 1, "description": "Yes"}]'), 'key'=>'id', 'value'=>'description'])
    @include('shineCompliance.forms.form_input',['title' => 'Sample Reference:', 'name' => 'sample_reference', 'data' =>'' ,'class_other' => 'equipment_section'])
</div>
@push('javascript')
    <script>
