...
@section('datatable_content')
    @if(isset($data) and count($data) > 0)
        ...
        @include('modals.training_record_edit',['color' => 'red', 'modal_id' => 'edit-policy-'.$dataRow->id,'action' => 'edit', 'client_id' => $dataRow->client_id,'data' => $dataRow, 'url' => route('ajax.training_record'), 'doc_type' => 'policy', 'title' => 'Edit Policy Document'])
        @endforeach
    @endif
@overwrite
