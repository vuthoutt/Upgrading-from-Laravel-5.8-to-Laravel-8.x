@extends('layouts.app')
@section('content')
@include('partials.nav', ['breadCrumb' => 'zone_map_child','data' => $zone])
...
<div class="container prism-content">
    ...
    <div class="row mt-5 ml-2">
        <div style="" class="site-map">
            <a href="{{ route('zone.group',['zone_id' => $corporate->id ?? 0,'client_id' => $client_id]) }}" style="text-decoration: none">
        ...
        <div class="site-map">
            <a href="{{ route('zone.group',['zone_id' => $commercial->id ?? 0,'client_id' => $client_id]) }}" style="text-decoration: none">
        ...
        <div class="site-map">
            <a href="{{ route('zone.group',['zone_id' => $non_domestic->id ?? 0,'client_id' => $client_id]) }}" style="text-decoration: none">
        ...
        <div class="site-map">
            <a href="{{ route('zone.group',['zone_id' => $domestic->id ?? 0,'client_id' => $client_id]) }}" style="text-decoration: none">
