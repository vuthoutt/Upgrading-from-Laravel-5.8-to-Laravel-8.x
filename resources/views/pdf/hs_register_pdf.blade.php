...
<div id="container" style="width: 859px">
    <h2>Health & Safety Hazard Register</h2>
    <?php
    if (count($hazards)) {
        ...
        echo '<p style="margin-top:20px;margin-bottom:10px">There were no hazards present within the Health & Safety Register at the time the export was requested.</p>';
    }//endif ?>
