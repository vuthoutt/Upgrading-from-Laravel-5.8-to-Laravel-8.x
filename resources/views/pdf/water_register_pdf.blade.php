...
<div id="container" style="width: 859px">
    ...
    if (count($hazards)) {
        ...
        echo '<p style="margin-top:20px;margin-bottom:10px">There were no hazards present within the Water Register at the time the export was requested.</p>';
    }//endif ?>
