        ...
        <div id="excutive-summary" style="margin-top: 30px;">
            ...
            <div style="width:99%;">
                ...
                <div id="property-thumb" style="margin-top:20px;margin-bottom:20px">
                    @if(\CommonHelpers::checkFile($property->id, PROPERTY_IMAGE))
                        <img height="250"
                             src="{{ \CommonHelpers::getFile($property->id, PROPERTY_IMAGE, $is_pdf) }}"
                             alt="Property Image"/>
                    @endif
                </div>
                ...
                <div id="property-details1">
                    ...
                    <p>{{$property->propertyInfo->flat_number ?? ''}}</p>
                    <p>{{$property->propertyInfo->building_name ?? ''}}</p>
                    <p>{{$property->propertyInfo->street_number ?? ''}}</p>
                    <p>{{$property->propertyInfo->street_name ?? ''}}</p>
                ...
                <div style="width:99%;">
                    ...
                    <div class="row">
                        ...
                        <p style="display:inline-block;width:59%;text-align:left;">
                            {{$property->propertyInfo->propertyInfoUser->full_name ?? ''}}
                        </p>
                    </div>
                    <div class="row">
                        <p style="display:inline-block;width:39%;text-align:left;">
                            Telephone: </p>
                        <p style="display:inline-block;width:59%;text-align:left;">
                            {{$property->propertyInfo->propertyInfoUser->contact->telephone ?? ''}}
                        </p>
                    </div>
                    <div class="row">
                        <p style="display:inline-block;width:39%;text-align:left;">
                            Mobile: </p>
                        <p style="display:inline-block;width:59%;text-align:left;">
                            {{$property->propertyInfo->propertyInfoUser->contact->mobile ?? ''}}
                        </p>
                    </div>
                    <div class="row">
                        <p style="display:inline-block;width:39%;text-align:left;">
                            Email: </p>
                        <p style="display:inline-block;width:59%;text-align:left;">
                            {{$property->propertyInfo->propertyInfoUser->email ?? ''}}
                        </p>
                    </div>
                </div>
                 ...
                 <div style="margin-top: 20px">
                    <div class="row" >
                        <p style="display:inline-block;width:39%;text-align:left;">
                            Property Asset Type: </p>
                        <p style="display:inline-block;width:59%;text-align:left;">
                            {{ $property->assetType->description ?? '' }}
                        </p>
                    </div>
                    <div class="row" >
                        <p style="display:inline-block;width:39%;text-align:left;">
                        ...
                        <p style="display:inline-block;width:59%;text-align:left;">
                            {{ $property->propertySurvey->propertyProgrammeType->description ?? null }}
                        </p>
                    </div>
                </div>
        </div>
