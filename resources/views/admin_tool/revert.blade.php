...
@section('toolbox_content')
    ...
    <div>
        <h3 class="text-center mt-4">Revert Back Action</h3>
        <form method="POST" id="form-action"  action="{{ route('toolbox.post_revert_back') }}">
            @csrf
            <input type="hidden" id="description" name="description">
            <div  id="form-admin-tool">
                @include('form_admin_tool.form_select_revert_back_type',['id' => 'select-type', 'title' => 'What would you like to revert back?'])
                <div class="row">
                    <div class="col-6 parent-cl" id="from_tab" data-text="from">
                        @include('form_admin_tool.search_survey',['id' => 'survey_search_old',  'hide' => false, 'class' => 'form-option', 'type_search' => 2 , 'title' => 'What Survey would you like to use?'])
                    </div>
            ...
            @include('modals.toolbox_submit',['title' => 'revert back', 'modal_id' => 'toolbox', 'header' => 'Are you sure you want to revert back the following?'])
