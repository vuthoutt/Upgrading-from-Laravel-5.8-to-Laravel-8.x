    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header {{ isset($color) ? CommonHelpers::getNavColor($color) : 'red_gradient' }}">
                <h5 class="modal-title" id="exampleModalLabel">shinePrism - Add Historical Document</h5>
            ...
            <div class="modal-body" style="padding-left: 30px;min-height:140px;width: 530px;">
                ...
                @include('forms.form_dropdown',['title' => 'Document Type:',
                                            ...
                                            'width' => 7,
                                            'name' => 'document_type',
                                            'id' => 'form-document_type'.$unique,
                                            'key'=> 'id',
                                            'value'=>'description',
                                            'required' => true ])
                <span class="invalid-feedback font-weight-bold modal-err-text" role="alert" id="document_type-err{{ $unique }}"></span>
                @include('forms.form_dropdown',['title' => 'Document Category:',
                                            'data' => $historical_categories ,
                                            'width_label' => 4,
                                            'width' => 7,
                                            'name' => 'category',
                                            'id' => 'form-category'.$unique,
                                            'key'=> 'id',
                                            'value'=>'category',
                                            'compare_value' => $id,
                                            'required' => true ])
                <span class="invalid-feedback font-weight-bold modal-err-text" role="alert" id="category-err{{ $unique }}"></span>
                ...
                {{-- @include('forms.form_checkbox',['title' => 'Management Survey PDF:', 'data' => '','compare' => 1, 'name' => 'is_external_ms', 'width_label' => 4 ]) --}}
                @include('forms.form_datepicker',['title' => 'Date:', 'name' => 'historic_date','id' => 'historic_date'.$unique  ,'width_label' => 4, 'data' => date('d/m/Y') ])
...
$(document).ready(function(){
    $('#add_historical_doc_{{$unique}}').click(function(e){
        ...
        $('#form-category{{ $unique }}').removeClass('is-invalid');
        $('#form-document_type{{ $unique }}').removeClass('is-invalid');
        var historic_date = $('#historic_date{{$unique}}').val();
