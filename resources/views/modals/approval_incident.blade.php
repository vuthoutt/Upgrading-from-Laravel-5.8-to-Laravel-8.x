    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:140px;padding-left: 80px;padding-top: 50px">
                <strong id="title-ques-incident-{{ $type }}" ></strong>
...
$('#{{ isset($modal_id) ? $modal_id : '' }}').on('show.bs.modal', function(e) {
    ...
    $('#title-ques-incident-{{ $type }}').html('Are you sure that you want to approval incident report ' + incident_ref + ' ?');
    $('#form-approval-{{ $type }}').attr('action', '/compliance/incident_reporting/approval/' + incident_id);
});
</script>
@endpush
