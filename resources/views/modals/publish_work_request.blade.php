    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header {{ isset($color) ? CommonHelpers::getNavColor($color) : 'red_gradient' }}">
                <h5 class="modal-title" id="exampleModalLabel">shineArc - Work Request Warning</h5>
            ...
            <div class="modal-body" style="padding-left: 130px;height:140px ">
                <strong>Are you sure that you want to publish {{ $work_request->reference }} ?</strong>

                    <div class="form-check" style="margin-top: 35px;">
                        <label class="switch">
                            <input type="checkbox" name="work_request_draf" class="primary" >
                            <span class="slider round"></span>
                        </label>
                        <strong style="margin-left: 15px;margin-top: 5px;">Work Request Draft Only</strong>
                    </div>
