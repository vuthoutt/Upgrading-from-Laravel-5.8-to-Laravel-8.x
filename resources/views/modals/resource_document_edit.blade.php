    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header {{ isset($color) ? CommonHelpers::getNavColor($color) : 'red_gradient' }}">
                <h5 class="modal-title" id="exampleModalLabel">shinePrism - Edit Resource Document</h5>
            ...
            <div class="modal-body" style="padding-left: 30px;min-height:140px;min-width: 530px;">
                <input type="hidden" class="form-control" name="category" value="{{ $data->category_id }}">
                ...
                @include('forms.form_datepicker',['title' => 'Date:', 'name' => 'date','id' => 'historic_date'.$data->id  ,'width_label' => 4, 'data' => $data->added ])
...
$(document).ready(function(){
    $('#submit_historical_doc_{{$data->id}}').click(function(e){
        ...
        form_data.append('date', historic_date);
