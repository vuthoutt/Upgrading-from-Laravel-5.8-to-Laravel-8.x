<div class="offset-top40">
    ...
    @include('forms.form_dropdown',['title' => 'Primary', 'data' => $pasPrimaries, 'name' => 'pasPrimary', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasPrimaries ])
    @include('forms.form_dropdown',['title' => 'Secondary', 'data' => $pasSecondaryies, 'name' => 'pasSecondary', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasSecondaryies ])

    @include('forms.form_text_right',['title' => 'Likelihood of Disturbance'])
    @include('forms.form_dropdown',['title' => 'Location', 'data' => $pasLocations, 'name' => 'pasLocation', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasLocations ])
    @include('forms.form_dropdown',['title' => 'Accessibility', 'data' => $pasAccessibilities, 'name' => 'pasAccessibility', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasAccessibilities ])
    @include('forms.form_dropdown',['title' => 'Extent/Amount', 'data' => $pasExtents, 'name' => 'pasExtent', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasExtents ])

    @include('forms.form_text_right',['title' => '  Human Exposure Potential'])
    @include('forms.form_dropdown',['title' => 'Number', 'data' => $pasNumbers, 'name' => 'pasNumber', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasNumbers ])
    @include('forms.form_dropdown',['title' => 'Frequency', 'data' => $pasHumanFrequencys, 'name' => 'pasHumanFrequency', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasHumanFrequencys ])
    @include('forms.form_dropdown',['title' => 'Average Time', 'data' => $pasAverageTimes, 'name' => 'pasAverageTime', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasAverageTimes ])

    @include('forms.form_text_right',['title' => '  Maintenance Activity'])
    @include('forms.form_dropdown',['title' => 'Type', 'data' => $pasTypes, 'name' => 'pasType', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasTypes ])
    @include('forms.form_dropdown',['title' => 'Frequency', 'data' => $pasMaintenanceFrequencys, 'name' => 'pasMaintenanceFrequency', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedPasMaintenanceFrequencys ])
