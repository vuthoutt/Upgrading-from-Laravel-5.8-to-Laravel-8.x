<div class="offset-top40">
    @include('forms.form_dropdown',['title' => 'Actions / recommendations', 'data' => $recommendations, 'name' => 'ActionsRecommendations[]', 'key'=> 'id', 'value'=>'description', 'id' => 'ActionsRecommendations' ])
