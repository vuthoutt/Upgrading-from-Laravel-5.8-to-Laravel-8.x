<div class="offset-top40">
    ...
    <div id="materialaltdiv">
        @include('forms.form_dropdown',['title' => 'Product Type (a)', 'data' => $assessmentTypeKeys, 'name' => 'assessmentTypeKey', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedAssessmentTypeKeys ])
        @include('forms.form_dropdown',['title' => 'Extent of Damage (b)', 'data' => $assessmentDamageKeys, 'name' => 'assessmentDamageKey', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedAssessmentDamageKeys ])
        @include('forms.form_dropdown',['title' => 'Surface Treatment (c)', 'data' => $assessmentTreatmentKeys, 'name' => 'assessmentTreatmentKey', 'key'=> 'id', 'value'=>'description', 'option_data' => 'score', 'compare_value' => $selectedAssessmentTreatmentKeys ])
