...
<table cellspacing="0" border="0" cellpadding="0" width="100%">
    ...
    <tr>
        <td valign="top">
            ...
            <p style="margin: 0; margin-top: 7px; margin-bottom: 20px; padding: 0; font-size: 13px; font-weight: normal; color: #535353; line-height: 22px; text-align: justify;">
                This is a courtesy email from Westminster City Council to inform you that: {{ $incident_report_reference }} has now been approved.
            </p>
            <p style="margin: 0; margin-top: 7px; margin-bottom: 20px; padding: 0; font-size: 13px; font-weight: normal; color: #535353; line-height: 22px; text-align: justify;">
                Please <a href="{{ $link_incident_report_detail }}" style="color: #1F497D; text-decoration: none;">log in to your account</a> or review the Incident Report PDF with the <a href="{{ $link_incident_report_pdf }}" style="color: #1F497D; text-decoration: none;">link</a> provided.
            </p>
