...
<table cellspacing="0" border="0" cellpadding="0" width="100%">
    <tr>
        <td valign="middle" height="37" style="height: 37px; border-bottom-color: #d6d6d6; border-bottom-width: 1px; border-bottom-style: solid; vertical-align: middle;">
            <h2 style="margin: 0; padding: 0; font-size: 16px; font-weight: bold; color: #1F497D; text-align: left;">Survey Rejected Notification</h2>
        </td>
    </tr>
    <tr>
        <td valign="top">
            ...
            <p class="paragraph marginBot20">
                This is a courtesy email from {{ $company_name }} to inform you that: {{ $survey_ref }} has been rejected.
            </p>
            <p class="paragraph marginBot20">
                Please <a href="{{ $domain }}" style="color: #1F497D; text-decoration: none;">log in to your account</a> and go to Rejected Page in the Data Centre.
            </p>
            <p class="paragraph">
                Kindest Regards,
            </p>
