...
<table cellspacing="0" border="0" cellpadding="0" width="100%">
    ...
    <tr>
        <td valign="top">
            ...
            <p class="paragraph ">
                This is a courtesy email from {{ $company_name }} to inform you:
            </p>
            <p class="paragraph marginBot20">

                Please use this <a href="{{ $domain.'user/confirm-new-email/' .$token. '?id=' .$user_id }}" style="color: #1F497D; text-decoration: none;"><strong>link</strong></a> to confirm your email.
