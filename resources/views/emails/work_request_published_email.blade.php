...
<table cellspacing="0" border="0" cellpadding="0" width="100%">
    ...
    <tr>
        <td valign="top">
            ...
            <p style="margin: 0; margin-top: 7px; margin-bottom: 20px; padding: 0; font-size: 13px; font-weight: normal; color: #535353; line-height: 22px; text-align: justify;">
                This is a courtesy email from {{ $company_name }} to inform you that {{ $work_request_reference }} is now awaiting your approval.
            </p>
            <p style="margin: 0; margin-top: 7px; margin-bottom: 20px; padding: 0; font-size: 13px; font-weight: normal; color: #535353; line-height: 22px; text-align: justify;">
                Please <a href="{{ $domain }}"> log in to your account</a> to review the work request in My Document Approvals or the Data Centre Approvals.
            </p>
