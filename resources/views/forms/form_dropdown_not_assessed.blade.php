<div class="row register-form" id="not-assessed-form">
    <label class="col-md-{{ isset($width_label) ? $width_label : 3 }} col-form-label text-md-left font-weight-bold" >Assessed
    @if(isset($required))
...
<div class="row register-form" id="not-assessed-reason-form">
    <label class="col-md-{{ isset($width_label) ? $width_label : 3 }} col-form-label text-md-left font-weight-bold" >Reason
    <span style="color: red;">*
    </label>
    <div class="col-md-{{ isset($width) ? $width : 5 }}">
        <div class="form-group ">
