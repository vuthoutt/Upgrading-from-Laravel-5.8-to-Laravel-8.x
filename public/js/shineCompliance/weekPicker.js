...
var setWeekCalendar = function(settingElement) {
    ...
    $(settingElement).datepicker({
        ...
        onSelect: function(dateText, inst) {
            ...
            if (datepickerValue.getMonth() == 11 && weekNum == 1) {
                weekYear += 1;
            }
            ...
            endDate = new Date(datepickerValue.getFullYear(), datepickerValue.getMonth(), datepickerValue.getDate() - datepickerValue.getDay() + 6, 23, 59,59);
            selectCurrentWeek();
            $(this).data('datepicker').inline = true;
            globalAdditionalFunction(globalTriggeringElement);
            $('#start_wk').val(startDate.getTime()/1000);
            $('#end_wk').val(endDate.getTime()/1000);
        },
        onClose: function() {
